...
User story: As a project manager, I want to know the time between an API specification is created in Anypoint exchange and when the MuleSoft API specification implementation goes into production, so that I can calculate the time it takes to onboard an API. I also want to know the maximum and average times.
