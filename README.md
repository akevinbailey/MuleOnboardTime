...
User story: As a project manager, I want to know the time between when an API specification is loaded into Anypoint Exchange and when the MuleSoft API specification implementation goes into production in API Manager, so that I can calculate the time it takes to onboard an API.  I also want to know the maximum and average times.
